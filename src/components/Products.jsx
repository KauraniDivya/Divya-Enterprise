...
const products = [
  {
    ...
    image: product1,
    icon: "🔧" // Wrench emoji for machinery and engines
  },
  {
    id: 2,
    name: "Furnace Oil",
    ...
    image: product2,
    icon: "🔥" // Fire emoji for furnaces and heat
  },
  {
    id: 3,
    ...
    image: product3,
    icon: "🔬" // Microscope emoji for chemical composition
  },
  {
    id: 4,
    name: "MTO",
    ...
    image: product4,
    icon: "🧪" // Test tube emoji for chemical processes
  },
  {
    id: 5,
  ...
  },
  {
    ...
    image: product6,
    icon: "⚙️" // Gear emoji for engines and machinery
  }
];
...
<div class="flex flex-wrap gap-10 py-50 mt-20 lg:justify-between items-center justify-center">
 ...
 key={products.id}
		...
		<div class="p-4">
			<img class="rounded-xl ml-2 mt-2" src={products.image} style={{height: "250px", minWidth: "full"}} alt="Dog" />
    </div>
			<div class="p-6">
      
				<div class="flex items-center justify-center text-center space-x-4">
{/* <p>{products.icon}</p> */}
					<h1 class="text-4xl text-gray-900 font-bold">{products.icon} {products.name}</h1>
				</div>
        <p class="mt-4 text-2xl">{products.description}</p>
